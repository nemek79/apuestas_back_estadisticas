...
/**
 * EstadisticaApuestaMesDTO
 */

public class EstadisticaApuestaMesDTO implements Serializable {

  private static final long serialVersionUID = 5758735970257134835L;
  ...
  public EstadisticaApuestaMesDTO(EstadisticaApuestaMes estadistica) {

    this.mes = estadistica.getMes();
  ...
  public EstadisticaApuestaMes asEstadisticaApuestaMes() throws Exception {

    EstadisticaApuestaMes estadistica = new EstadisticaApuestaMes();

    estadistica.setAno(this.ano);
    estadistica.setMes(this.mes);
