...
/**
 * EstadisticaApuestaMes
 */

@Entity
@Table(name="t_est_apuestas_mes")
public class EstadisticaApuestaMes implements Serializable {

  private static final long serialVersionUID = -6488297920496692055L;
